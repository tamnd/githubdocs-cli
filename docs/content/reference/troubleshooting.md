...
Most of these come down to network reality or how githubdocs serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

githubdocs rate-limits like any public site. ghdocs already paces
...
Where a surface is gated, ghdocs reads a cookie or token you supply
...
`ghdocs`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ghdocs actually did
